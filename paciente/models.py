...
class Paciente(models.Model):
	...
	convenio = models.ForeignKey('base.Convenio', on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Convênio")
	...
	class Meta:
		constraints = [
			models.UniqueConstraint(fields=['clinica', 'cpf'], name='paciente_unique_cpf_por_clinica')
		]
...
class PacienteVacina(models.Model):
	...
	paciente = models.ForeignKey(Paciente, on_delete=models.CASCADE, related_name='vacinas', verbose_name="Paciente")
	...
	aplicador = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True, related_name='vacinas_aplicadas', verbose_name="Aplicador")
	forma_pagamento = models.ForeignKey('base.FormaPagamento', on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Forma de Pagamento")
	...
	def __str__(self):
		return f"{self.paciente.nome} - {self.descricao_vacina or 'Vacina não informada'}"
